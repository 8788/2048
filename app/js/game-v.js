...
;(function (win) {
    ...
    function updateView(nums) {
        var oldNumbers = util.getByClass('number', box);
    ...
    function updateScore(score) {
        var ele = util.getByClass('current')[0];
        ele.innerHTML = score;
    }

    function updateBestScore(score) {
        var ele = util.getByClass('best')[0];
        ele.innerHTML = score;
    }
    ...
    function moveAnimate(fromX, fromY, toX, toY) {
        var ele = util.getByClass('number-'+fromX+'-'+fromY, box)[0];
